...
class ProductEdit extends Viewer
{
        ...
        <div class="col-10 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="/admin/product/update/<?= $data['product']['id'] ?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="name">Tên sản phẩm</label>
                            <input type="text" class="form-control" name="name" id="name" value="<?= htmlspecialchars($data['product']['name'] ?? '') ?>" placeholder="Name">
                        </div>

                        <div class="form-group">
                            <label for="description">Mô tả sản phẩm</label>
                            <textarea class="form-control" id="description" rows="4" name="description"><?= htmlspecialchars($data['product']['name'] ?? '') ?></textarea>
                        </div>
